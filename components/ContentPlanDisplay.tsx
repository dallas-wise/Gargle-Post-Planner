      ...
      <div className="text-center">
        ...
        <div className="mt-6">
          <button
            ...
            className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-[#156fb9] hover:bg-[#125e9f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#156fb9] transition-colors"
          >
