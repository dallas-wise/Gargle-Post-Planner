    ...
    <div className="bg-gray-50 rounded-lg p-5 border border-gray-200 flex flex-col h-full relative">
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        ...
        <button
          ...
          className="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-800 disabled:text-gray-400 disabled:cursor-wait transition-colors"
        >
